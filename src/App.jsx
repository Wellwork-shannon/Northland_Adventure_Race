...
import hero from '/hero.jpg' // must exist at public/hero.jpg

export default function App() {
  const [sending, setSending] = useState(false)
  const [status, setStatus] = useState('')
  const FORMSPREE_ENDPOINT = 'DEMO' // replace with real endpoint later
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero using the photo from /public/hero.jpg */}
      <section id="hero" className="relative isolate overflow-hidden">
        <div className="mx-auto max-w-6xl px-4 py-14 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div
            ...
            aria-label="Northland coastline"
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-4 py-16">
          ...
          <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-1 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-slate-600">Or email <a href="mailto:Kiaora@Northlandadventurerace.nz" className="underline">Kiaora@Northlandadventurerace.nz</a></p>
            </div>
