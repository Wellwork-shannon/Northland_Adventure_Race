    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section id="contact" className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-16">
          ...
          <div className="mt-2 text-slate-700 text-sm">Prefer to talk? Call <a href="tel:64211224662" className="underline">021 122 4662</a> or email <a href="mailto:Kiaora@northlandadventurerace.nz" className="underline">Kiaora@northlandadventurerace.nz</a>.</div>
